...
public class Keys {
    ...
    public static final UniqueKey<GithubCommitRecord> GITHUB_COMMIT_PK = Internal.createUniqueKey(GithubCommit.GITHUB_COMMIT, DSL.name("GITHUB_COMMIT_PK"), new TableField[] { GithubCommit.GITHUB_COMMIT.SHA }, true);
    ...
    public static final UniqueKey<SiteTypeRecord> CONSTRAINT_8 = Internal.createUniqueKey(SiteType.SITE_TYPE, DSL.name("CONSTRAINT_8"), new TableField[] { SiteType.SITE_TYPE.SITE_TYPE_ID }, true);
    public static final UniqueKey<SiteTypeRecord> CONSTRAINT_88 = Internal.createUniqueKey(SiteType.SITE_TYPE, DSL.name("CONSTRAINT_88"), new TableField[] { SiteType.SITE_TYPE.NAME }, true);
    ...
    public static final ForeignKey<LinkRecord, SiteTypeRecord> LINK_SITE_TYPE_SITE_TYPE_ID_FK = Internal.createForeignKey(Link.LINK, DSL.name("LINK_SITE_TYPE_SITE_TYPE_ID_FK"), new TableField[] { Link.LINK.SITE_TYPE_ID }, Keys.CONSTRAINT_8, new TableField[] { SiteType.SITE_TYPE.SITE_TYPE_ID }, true);
