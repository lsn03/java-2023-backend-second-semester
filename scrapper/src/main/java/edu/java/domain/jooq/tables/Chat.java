...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The column <code>CHAT.ACTIVE</code>.
     */
    public final TableField<ChatRecord, Boolean> ACTIVE = createField(DSL.name("ACTIVE"), SQLDataType.BOOLEAN.defaultValue(DSL.field(DSL.raw("TRUE"), SQLDataType.BOOLEAN)), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function2<? super Long, ? super Boolean, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function2<? super Long, ? super Boolean, ? extends U> from) {
