...
public class LinkChat extends TableImpl<LinkChatRecord> {
     ...
     */
    public final TableField<LinkChatRecord, Long> CHAT_ID = createField(DSL.name("CHAT_ID"), SQLDataType.BIGINT, this, "");
    ...
    @Override
    @NotNull
    public List<UniqueKey<LinkChatRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.LINK_CHAT_PK);
    }

    @Override
    @NotNull
    public List<ForeignKey<LinkChatRecord, ?>> getReferences() {
        return Arrays.asList(Keys.LINK_TO_USER_LINK_LINK_ID_FK, Keys.LINK_TO_USER_USER_USER_ID_FK);
    }
    ...
    public Link link() {
        if (_link == null)
            _link = new Link(this, Keys.LINK_TO_USER_LINK_LINK_ID_FK);
    ...
    public Chat chat() {
        if (_chat == null)
            _chat = new Chat(this, Keys.LINK_TO_USER_USER_USER_ID_FK);
